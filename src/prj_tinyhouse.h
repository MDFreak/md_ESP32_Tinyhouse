  ...
  // ******************************************
    ...
    // --- sensors
      ...
      #define USE_BME680_I2C        OFF   // [0, 1, ....] limited by I2C channels/addr
      ...
      #define USE_VCC50_ANA         ON // ADC or ADS1115
      #define USE_VCC33_ANA         ON // ADC or ADS1115
